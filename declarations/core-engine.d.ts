...
declare function EntityModel(parentModel?: any): void;
declare function EntityModelWatcher(entity: number, model: any): void;
declare function EntityAIWatcher(customPrototype: any): void;
 ...
 * ids as values
 */
declare const BlockID: {[namedID: string]: number};

/**
 * Object containing string custom block string ids as keys and their numeric
 * ids as values
 */
declare const ItemID: {[namedID: string]: number};
 ...
 * @param arg
 */
declare function alert(arg: any): void;
...
declare class CustomEntity {
    ...
    setBaseType(type: Native.EntityType): void;

    customizeVisual(custom: {
        getModels?: () => {main: EntityModel}
    }): void;

    customizeDescription(custom: {
        getHitbox?: () => {w: number, h: number},
        getDrop?: () => {id: number, count?: number, data?: number, chance?: number, separate?: boolean}[]
    }): void;
...
declare namespace FileTools {
     ...
     */
    function ReadImage(file: string): android.graphics.Bitmap;
...
declare namespace GenerationUtils {
     ...
     * superflat worlds
     */
    function generateOre(x: number, y: number, z: number, id: number, data: number, amount: number, noStoneCheck?: boolean, random?: number): void;
}
/**
...
declare namespace LiquidRegistry {
    ...
    var FullByEmpty: {[key: string]: {id: number, data: number}};
    var EmptyByFull: {[key: string]: {id: number, data: number, liquid: string}};
...
declare namespace Recipes {
     ...
     */
    function addShaped(result: ItemInstance2, mask: string[], data: (string|number)[], func?: CraftingFunction, prefix?: string): void;
...
declare namespace TileEntity {
     ...
     * behavior
     */
    function registerPrototype(blockID: number, customPrototype: any): void;
    ...
    interface TileEntityPrototype {
         ...
         */
		getGuiScreen?: () => UI.Window | UI.StandartWindow | UI.StandardWindow | UI.TabbedWindow;
...
declare namespace UI {
	...
	interface UIElement {
        ...
        max?: number;
        isInt?: boolean;
        onNewState?: (val: boolean, container: UI.Container, elem: UI.Element) => void;
        onNewValue?: (val: number, container: UI.Container, elem: UI.Element) => void;
        onTouchEvent?: (elem: UI.Element, event: {localX: number, localY: number}) => void;
        index?: number;
        isValid?: (id: number, count: number, data: number) => boolean;
        pixelate?: boolean;
	...
	interface UIClickEvent {
        onClick?(container: UI.Container, tileEntity: TileEntity, window: UI.Element, canvas: android.graphics.Canvas, scale: number): void;
        onLongClick?(container: UI.Container, tileEntity: TileEntity, window: UI.Element, canvas: android.graphics.Canvas, scale: number): void;
	}
